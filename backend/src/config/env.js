...
module.exports = {
  ...
  mongoDnsServers: splitCsv(process.env.MONGO_DNS_SERVERS),
  ...
  sanitationApiBaseUrl: process.env.SANITATION_API_BASE_URL || '',
  sanitationPublicApiKey: process.env.SANITATION_PUBLIC_API_KEY || '',
  safetyNewsFeedsJson: process.env.SAFETY_NEWS_FEEDS_JSON || '',
  safetyNewsFeeds: process.env.SAFETY_NEWS_FEEDS || '',
  safetyNewsRefreshMs: Number(process.env.SAFETY_NEWS_REFRESH_MS || 30 * 60 * 1000),
  safetyNewsMaxItems: Number(process.env.SAFETY_NEWS_MAX_ITEMS || 50),
